...
if __name__ == "__main__":
    ...
    mymap.marker(37.427, -122.145, "yellow", label="<h1>My label</h1><hr><p>This is a dangerous point</p>")
    mymap.marker(37.428, -122.146, "cornflowerblue", label="A large label. With multiple lines")
    mymap.marker(37.429, -122.144, "k", label="Another label")
